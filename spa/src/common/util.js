...
class Util {
    ...
    show_success_top(text) {
        Swal.fire({ icon: 'success', position: 'top', text, timer: 3000 });
    }
    ...
    show_confirm_top(text, ok_text, no_text, tm = 9) {
        ...
        return new Promise((resolve, reject) => {
            ...
            Swal.fire({
                ...
                denyButtonText: `${no_text}(<strong></strong>)`,
                timer: tm,
                willOpen: () => {
    ...
    show_alert_top(text) {
        Swal.fire({ position: 'top', text });
    }
    show_alert_top_tm(text, timeout = 3000) {
        Swal.fire({ position: 'top', text, timer: timeout });
    }
    show_info_center_tm(text, timeout = 3000) {
        Swal.fire({ icon: 'info', position: 'center', text, timer: timeout });
    }
    show_warn_top(text) {
        Swal.fire({ icon: 'warning', position: 'top', text });
    }
    show_error_top(text) {
        Swal.fire({ icon: 'error', position: 'top', text });
    }
